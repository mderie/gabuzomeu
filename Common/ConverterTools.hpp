...
extern bool write;
extern size_t extention; // Bitfield ! Later we could turn big, Quine & write into extentions... Split it in languageExtention & interpreterExtention ?

enum class Extention { none = 0, label = 1, litteral = 2, spaceship = 4, line = 8 }; // We could also imagine to use distinct letter...

enum class Base { unknown = 0, two = 2, four = 4, eight = 8, ten = 10, sixteen = 16, sixtyFour = 64, default_ = 256 };
